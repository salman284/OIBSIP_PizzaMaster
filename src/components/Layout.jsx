    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-orange-50 to-red-50">
        ...
        <main className="flex-1 flex flex-col md:ml-64">
          <header className="bg-white/80 backdrop-blur-md border-b border-orange-200 px-4 py-4 flex items-center gap-3 md:hidden sticky top-0 z-30 shadow-sm">
            <SidebarTrigger className="hover:bg-orange-100 p-2 rounded-lg transition-colors duration-200" />
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-r from-red-600 to-orange-500 rounded-full flex items-center justify-center shadow-md">
